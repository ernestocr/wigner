...
al subcampo primo de $\F_d$ con $\Z_p$. Definamos a la
...
Ahora introducimos el concepto de una suma Gaussiana. Sean
...
\subsection{La represetnación \texorpdfstring{$p$}-ádica}
