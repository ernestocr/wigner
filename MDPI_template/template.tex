...
\newcommand{\orcidauthorC}{} % Add \orcidC{} behind the author's name
...
\begin{figure}[ht]%
    \centering
    \subfloat[\centering Abelian curve (\ref{ac2})
	]{{\includegraphics[width=6.5cm]{abelian.eps} }}%
	\quad
    \subfloat[\centering Non-abelian curve (\ref{nac})
