...
\begin{document}
  ...
  función de Wigner discreta que definen Wootters y Gibbons
  ...
  particular la propiedad tomográfica. Ésta
  ...
  Wootters y Gibbons requiere de la construcción explícita
  ...
  En su artículo del 2004 [CITE], Gibbons y Wootters
  ...
  $\rho$. Wootters y Gibbons intentan definir una versión
  discreta siguiendo éstos pasos, cuidando que la
  construcción preserve otras propiedades de la versión
  continua.  Resulta que su método introduce cierto tipo de
  ...
  es limitante, pero Wootters y Gibbons hacen la observación
  que su método es válido para el importante caso de un
  sistema de $n$ qubits. Por lo tanto su metodología es
  directamente aplicable a los modelos de la computación e
  ...
  Wootters y Gibbons llaman aquellas asignaciones adecuadas,
  ...
  Wootters y Gibbons es la noción de las traslaciones en el
  ...
  elegin Gibbons y Wootters es construir los operadores a
  ...
  unitariamente equivalentes a las de Wootters y Gibbons,
  ...
  Recall Klimovs ideas about defining curves on the phase
  space.
  ...
  La idea es utilizar spreads simplécticos distintos a los
  de Wootters para obtener bases de MUBs no unitariamente
  equivalentes. Utilizando la construcción de Wootters
  podemos definir una función de Wigner que preserve la
  propiedad tomográfica básica. 

  \subsection{Spreads simplécticos}

  En la geometría proyectiva, determinar como, si es
  posible, cubrir un espacio proyectivo por subespacios
  mutuamente disjuntos de la misma dimensión, es un problema
  con numerosas aplicaciones [CITE]. Tal partición se conoce
  como \textit{spread}.
  ...
  \subsection{Definición no estándar de una función de
  Wigner discreta}
