...
\begin{figure}[ht]
  ...
  \centering
  \subfloat[\centering]{{
    \includegraphics[width=6.5cm]{DPS_rays_heat.eps}
  }}
  \quad 
  \subfloat[\centering]{{
    \includegraphics[width=6.5cm]{DPS_curve_heat.eps}
  }}
  \caption{
    \color{teal}
...
In this Appendix we derive Eq.(\ref{WF qubit}) of the main text.

Taking into account the expansion inverse to (\ref{Dexp}),
...
\begin{equation*}
  ...
  \delta_{\alpha^{\prime }(\tau),\gamma} \delta_{\beta^{\prime }(\tau),\delta},
\end{equation*}
...
{\color{teal}In this Appendix we provide the explicit expressions for the
reconstruction of the states $|\psi_{0}^{(\beta;1,\sigma^{5})}(0,9,0)\rangle$
and $|\psi_{0}^{(\beta ;\sigma^{2},\sigma^{5})}(0,9,0)\rangle$ associated to the
...
\begin{eqnarray*}
  ...
  = \begin{array}{ccccccccc}
    ...
    0 & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & 
    \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & 
    \multicolumn{1}{r}{} & \multicolumn{1}{r}{} \\ 
    \sigma  & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{}
    & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & 
    \multicolumn{1}{r}{} & \multicolumn{1}{r}{} \\ 
    \sigma ^{2} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & 
    \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & 
    \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} \\ 
    \sigma ^{3} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & 
    \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & 
    \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} \\ 
    \sigma ^{4} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & 
    \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & 
    \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} \\ 
    \sigma ^{5} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & 
    \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & 
    \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} \\ 
    \sigma ^{6} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & 
    \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & 
    \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} \\ 
    \sigma ^{7} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & 
    \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & 
    \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{}%
  \end{array}, \\
...
{\color{teal}where the  MUBs associated with the partition of the DPS in rays
(\ref{rays}) have the form,}

\begin{eqnarray*}
  |\psi_{\kappa }^{\lambda }\rangle
  &=& 2^{-3/2} \sum_{\alpha,\gamma \in \mathbb{F}_{2^{3}}}
...
{\color{teal}and the phases $\Phi_{\alpha,\beta}$ are defined in (\ref{ray
dps}).}
